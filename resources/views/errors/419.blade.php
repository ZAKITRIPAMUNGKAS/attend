...
<head>
    ...
    <title>419 — Sesi Kedaluwarsa · SmartPresensi</title>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent}
        ...
        .glow{position:absolute;top:-40px;right:-40px;width:150px;height:150px;background:rgba(167,139,250,.2);border-radius:50%;filter:blur(40px);pointer-events:none}
        .glow2{position:absolute;bottom:-40px;left:-40px;width:120px;height:120px;background:rgba(167,139,250,.12);border-radius:50%;filter:blur(30px);pointer-events:none}
        ...
        .icon-box{width:72px;height:72px;border-radius:1.5rem;background:#F5F3FF;border:1px solid #DDD6FE;display:flex;align-items:center;justify-content:center;margin:0 auto 1.25rem}
        .code{font-size:3.5rem;font-weight:900;letter-spacing:-2px;background:linear-gradient(135deg,#7C3AED,#A78BFA);background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:.5rem}
        ...
        .divider{width:40px;height:2px;background:linear-gradient(90deg,#7C3AED,#A78BFA);border-radius:2px;margin:1.25rem auto}
...
<body>
    <div class="card">
        ...
        <div class="icon-box">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#7C3AED" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
        </div>
        <div class="code">419</div>
        <h1>Sesi Kedaluwarsa</h1>
        <div class="divider"></div>
        <p>Sesi kamu telah kedaluwarsa karena terlalu lama tidak aktif. Silakan refresh halaman atau login ulang untuk melanjutkan.</p>
