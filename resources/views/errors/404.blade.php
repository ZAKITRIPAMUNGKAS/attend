...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan · SmartAbsensi</title>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent}
        ...
        .glow{position:absolute;top:-40px;right:-40px;width:150px;height:150px;background:rgba(186,230,253,.3);border-radius:50%;filter:blur(40px);pointer-events:none}
        .glow2{position:absolute;bottom:-40px;left:-40px;width:120px;height:120px;background:rgba(186,230,253,.2);border-radius:50%;filter:blur(30px);pointer-events:none}
        ...
        .icon-box{width:72px;height:72px;border-radius:1.5rem;background:#EEF5FC;border:1px solid #BFDBFE;display:flex;align-items:center;justify-content:center;margin:0 auto 1.25rem}
        .code{font-size:3.5rem;font-weight:900;letter-spacing:-2px;background:linear-gradient(135deg,#1E88E5,#42A5F5);background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:.5rem}
        ...
        .divider{width:40px;height:2px;background:linear-gradient(90deg,#1E88E5,#42A5F5);border-radius:2px;margin:1.25rem auto}
...
<body>
    <div class="card">
        ...
        <div class="icon-box">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#1E88E5" stroke-width="1.8"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/><line x1="11" y1="8" x2="11" y2="11"/><circle cx="11" cy="14.5" r=".5" fill="#1E88E5"/></svg>
        </div>
        <div class="code">404</div>
        <h1>Halaman Tidak Ditemukan</h1>
        <div class="divider"></div>
        <p>Maaf, halaman yang kamu cari tidak ada atau sudah dipindahkan. Periksa kembali URL yang dimasukkan.</p>
