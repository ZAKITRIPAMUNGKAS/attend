...
<head>
    ...
    <title>403 — Akses Ditolak · SmartPresensi</title>
    ...
    <style>
        *{box-sizing:border-box;margin:0;padding:0;-webkit-tap-highlight-color:transparent}
        ...
        .glow{position:absolute;top:-40px;right:-40px;width:150px;height:150px;background:rgba(254,202,202,.25);border-radius:50%;filter:blur(40px);pointer-events:none}
        .glow2{position:absolute;bottom:-40px;left:-40px;width:120px;height:120px;background:rgba(254,202,202,.15);border-radius:50%;filter:blur(30px);pointer-events:none}
        ...
        .icon-box{width:72px;height:72px;border-radius:1.5rem;background:#FFF5F5;border:1px solid #FECACA;display:flex;align-items:center;justify-content:center;margin:0 auto 1.25rem}
        .code{font-size:3.5rem;font-weight:900;letter-spacing:-2px;background:linear-gradient(135deg,#EF4444,#F87171);background-clip:text;-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:.5rem}
        ...
        .divider{width:40px;height:2px;background:linear-gradient(90deg,#EF4444,#F87171);border-radius:2px;margin:1.25rem auto}
...
<body>
    <div class="card">
        ...
        <div class="icon-box">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#EF4444" stroke-width="1.8"><rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 0 1 10 0v4"/><circle cx="12" cy="16" r="1" fill="#EF4444"/></svg>
        </div>
        <div class="code">403</div>
        <h1>Akses Ditolak</h1>
        <div class="divider"></div>
        <p>Kamu tidak memiliki izin untuk mengakses halaman ini. Silakan login dengan akun yang sesuai atau hubungi administrator.</p>
        ...
        <a href="{{ route('login') }}" class="btn-secondary">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" x2="3" y1="12" y2="12"/></svg>
            Masuk / Ganti Akun
        </a>
    </div>
